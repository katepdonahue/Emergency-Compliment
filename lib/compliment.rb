...
class Compliment
  ...
  MESSAGES = ["Your apartment is cozy. Like a lite brite that says 'Welcome!'.",
               "If YOU don't get it than I'm worried.",
               "I would like to buy a significant piece of art from you anytime, power girl.",
